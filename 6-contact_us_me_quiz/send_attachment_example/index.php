...
if(isset($_POST['send']))
{
    ...
    sendAttachment($from_name, $from_email, $subject, $attachment_temp, $attachment_type, $attachment_name_without_ext);
}


// Create a function to send attachment
function sendAttachment($from_name, $from_email, $subject, $attachment_temp, $attachment_type, $attachment_name_without_ext) 
{
